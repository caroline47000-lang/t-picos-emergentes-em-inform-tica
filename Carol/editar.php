...
if(isset($_POST['atualizar'])){
    ...
    $sqli2 = "UPDATE contatos SET nome = '$novo_nome';
    ...
    If(mysqli_query($conexao, $sql2)){
        ...
        echo "<h2>Erro ao atualizar. </h2>" . mysqli_error($conexaol);
        echo "<a href='index.php'>VOLTAR</a>";
        exit;
    }   
}
...
<form method="post">
    ...
    Endereço: <input type="text" name="endereco" <?php echo $contato['endereco']; ?>"><br>
    Telefone: <input type="text" name="fone" <?php echo $contato['fone']; ?>"><br>
